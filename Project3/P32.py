...
mlp = MLPClassifier(hidden_layer_sizes=(8, 16, 8), max_iter=4000, activation = 'tanh', solver = 'sgd')           #Making a Multi-Layer-Percepton Classifier model 
...
#We see that the accuracy has increased by around 30%
